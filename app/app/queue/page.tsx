...
// The worklist IS the product: this route is the live hypertension care-gap worklist.
// A command header frames it as a clinical dashboard; open any patient for the evidence,
// the decision path, and a drafted outreach message in their language. The pitch
// narrative lives on the home page (/).
    ...
    <div className="mx-auto max-w-[1240px] px-6 py-7">
      <header className="mb-5">
        ...
        <p className="text-[13.5px] text-[color:var(--muted)] mt-1.5 max-w-[86ch] leading-[1.55]">
          ...
          <Link href="/" className="text-[color:var(--accent)] hover:underline">What is CATCH?</Link>
        </p>
      </header>
